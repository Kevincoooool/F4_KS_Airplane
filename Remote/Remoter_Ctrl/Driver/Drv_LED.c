...
void LED_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_LED_0,ENABLE);

	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Pin   = Pin_LED_0;
	GPIO_Init(GPIO_LED_0, &GPIO_InitStructure);
...
void LED_0_ON(void)
{
	GPIO_ResetBits(GPIO_LED_0, Pin_LED_0);	
}

void LED_0_OFF(void)
{
	GPIO_SetBits(GPIO_LED_0, Pin_LED_0);			
}
