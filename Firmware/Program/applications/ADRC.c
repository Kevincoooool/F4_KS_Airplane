...
文件作用:ADRC控制
*******************************************************************************************************************/
Fhan_Data ADRC_GYRO_Controller;
Fhan_Data ADRC_SPEED_Controller;
Fhan_Data ADRC_SPEED_MIN_Controller;
...
/*  r     h      N                  beta_01   beta_02    beta_03     b0     beta_0  beta_1     beta_2     N1     C    alpha1  alpha2  zeta       b*/
 {1000000 ,0.005 , 2,               300,      7000,      1000,      20,    0.95,   1.5,      0.001,      200,    5,    0.7,   1.0,    0.01,    0.1},
 {1000000 ,0.005 , 2,               300,      7000,      1000,      20,    0.85,   1.5,      0.0003,      200,    5,    0.8,   1.2,    0.03,    0.1},
 {100000 ,0.01 , 5,               300,      4000,      10000,     100,   0.2,    1.2,      0.0010,      5,      5,    0.8,   1.5,    0.03,    0.05}
};
...
void ADRC_Init(Fhan_Data *fhan_Input1,Fhan_Data *fhan_Input2,Fhan_Data *fhan_Input3)
{
  ...
  fhan_Input3->N0=(u16)(ADRC_Unit[2][2]);
  ...
  fhan_Input3->N1=(u16)(ADRC_Unit[2][10]);
...
//     ********/
     ...
     */
      ...
      fhan_Input->u=Constrain_Float(fhan_Input->u,-950,950);//加入扰动补偿
}
