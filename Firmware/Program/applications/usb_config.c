...
#define USBD_STRDESC_MAN            L"KSTC Software"
#define USBD_STRDESC_PROD           L"KSTC USB Device"
...
#define USBD_HID_STRDESC            L"KSTC_HID"
...
#define USBD_MSC_STRDESC            L"KS_Pilot_MSC"
